export default function ChatContact({ name, onClick }) {
    return (
        <div className="flex hover:bg-slate-100/20 active:bg-slate-700 w-full items-center duration-150 gap-3 py-2 rounded-xl cursor-pointer select-none" onClick={onClick}>
